...
process {
    ...
    $NETVERSION_46                  = 393297
    $NETVERSION_461                 = 394271
      ...
      Switch ($State["InstallPhase"]) {
        1 {
            ...
            If( @($WS2008R2_MAJOR, $WS2012_MAJOR, $WS2012R2_MAJOR, $WS2016_MAJOR) -contains $MajorOSVersion) {
                ...
                Save-State $State
                If( $State["Install461"] -or $State["Install462"]) {
                    # Install hotfixes required by .NET Framework 4.6.x
                    Switch( $MajorOSVersion) {
                        $WS2008R2_MAJOR {
                        }
                        $WS2012_MAJOR {
        ...
        2 {
            ...
            If( $State["Install461"] -or $State["Install462"]) {
                If( $MajorOSVersion -eq $WS2016_MAJOR) {
                    Write-MyWarning 'Windows Server 2016 comes with .NET Framework 4.6.2'
                }
                Else {
